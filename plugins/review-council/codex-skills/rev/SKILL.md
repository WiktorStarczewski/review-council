...
clusters (one cluster per eventual commit, made only later at "Commit only when"
below, not here). Preserve user changes. Run the relevant gates and bring them to
