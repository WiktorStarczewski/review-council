...
- Document the bounded release lane: N-1 review with the installed 0.4.3 bundle,
  deterministic candidate gates, targeted canaries, P0/P1-only repairs, and a
  two-generation cap before certification.
